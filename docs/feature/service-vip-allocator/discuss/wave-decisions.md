...
| D4 | Exact shared-primitive shape (trait vs. concrete generic) deferred to DESIGN | DISCUSS commits only to "the underlying allocator logic is shared between BackendId and ServiceVip allocators". The factoring is an implementation decision. |
