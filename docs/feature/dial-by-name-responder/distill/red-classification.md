...
| S-DBN-COHERENCE-01 | 1 | NEW (02-00) | `MISSING_FUNCTIONALITY` | single-ordered-drain ordering invariant (`by_frontend` before `name_index`) `todo!` |
| S-DBN-EQUIV-01 | 1 | NEW (02-00) | `MISSING_FUNCTIONALITY` | re-keyed `classify` host-vs-in-memory equivalence harness `todo!` |
