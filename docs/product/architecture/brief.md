...
peer workload's SVID, never the workload itself. Both directions are spike-proven
on 7.0 (`findings-inbound-intercept.md` for the inbound half). The **guest-stack
