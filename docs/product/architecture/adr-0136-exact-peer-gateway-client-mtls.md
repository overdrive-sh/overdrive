# ADR-0136 — Require the receipt-selected workload identity in gateway-client mTLS
...
- The gateway SVID holder remains inaccessible to request handlers and other
  consumers.
- Gateway SVID lifecycle remains independently owned by ADR-0119.
...
- [Gateway SVID ADR-0119](adr-0119-dedicated-gateway-svid-identity-lifecycle.md)
- [Receipt ADR-0134](adr-0134-gateway-connect-selected-backend-receipt.md)
- [System trust ADR-0130](adr-0130-separate-public-tls-from-gateway-svid-workload-mtls.md)
