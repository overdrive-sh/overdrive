...
SM49AgEGCCqGSM49AwEHA0IABMf7kyT+KHEgfSG9Ef8OjLSjDQZ1NXsOEMhc7npv\n\
LK3b04EA6dyuTQUe7KH7TnAhjsBilX0PS5VZIRGLYQ+++VqjgZgwgZUwDAYDVR0T\n\
AQH/BAIwADAOBgNVHQ8BAf8EBAMCB4AwNQYDVR0RBC4wLIYqc3BpZmZlOi8vb3Zl\n\
cmRyaXZlLmxvY2FsL3dvcmtsb2FkL3NpbS1zdmlkMB0GA1UdDgQWBBQ14NPmBMWd\n\
Uo5Nphbcv1a60MmvXTAfBgNVHSMEGDAWgBRw0OxhpKhwt8rxBzYuQBhduPvB/TAK\n\
BggqhkjOPQQDAgNJADBGAiEA8fDX/MowPKNhsrHZq9t9Aj4HT0NRyj3dk9s6ym3O\n\
VSICIQDPTJSgBO9Yi6jLS3vvvlqFACopGx+1a8WICAY6M54Ygg==\n\
-----END CERTIFICATE-----\n";

/// Pre-generated fixture workload-SVID leaf **private key** (PKCS#8 PEM), the
/// matching private half of the public key embedded in [`FIXTURE_SVID_CERT_PEM`]
/// — returned on [`SvidMaterial::leaf_key`] per ADR-0063 D9 (node-held custody).
///
/// The cert↔key correspondence is load-bearing: the fixture leaf cert + this key
/// were minted together as a matched P-256 pair (the cert's
/// `SubjectPublicKeyInfo` is the public half of this key), so the
/// [`Ca::issue_svid`] postcondition "the returned cert's embedded public key
/// matches the returned leaf private key" holds for the sim adapter exactly as it
/// does for the host adapter. A `const` → byte-identical across seeds, so KPI K5
/// (serial-only determinism) is preserved. Held opaquely like the other fixture
/// keys; the sim never parses it.
const FIXTURE_SVID_KEY_PEM: &str = "-----BEGIN PRIVATE KEY-----\n\
MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQg5JMz9ObSjclOGzq9\n\
QGQVpSTuc1r8T9Od5iytvofNtL+hRANCAATH+5Mk/ihxIH0hvRH/Doy0ow0GdTV7\n\
DhDIXO56byyt29OBAOncrk0FHuyh+05wIY7AYpV9D0uVWSERi2EPvvla\n\
-----END PRIVATE KEY-----\n";
...
const FIXTURE_SVID_CERT_DER: &[u8] = &[
    ...
    0x42, 0x00, 0x04, 0xc7, 0xfb, 0x93, 0x24, 0xfe, 0x28, 0x71, 0x20, 0x7d, 0x21, 0xbd, 0x11, 0xff,
    0x0e, 0x8c, 0xb4, 0xa3, 0x0d, 0x06, 0x75, 0x35, 0x7b, 0x0e, 0x10, 0xc8, 0x5c, 0xee, 0x7a, 0x6f,
    0x2c, 0xad, 0xdb, 0xd3, 0x81, 0x00, 0xe9, 0xdc, 0xae, 0x4d, 0x05, 0x1e, 0xec, 0xa1, 0xfb, 0x4e,
    0x70, 0x21, 0x8e, 0xc0, 0x62, 0x95, 0x7d, 0x0f, 0x4b, 0x95, 0x59, 0x21, 0x11, 0x8b, 0x61, 0x0f,
    0xbe, 0xf9, 0x5a, 0xa3, 0x81, 0x98, 0x30, 0x81, 0x95, 0x30, 0x0c, 0x06, 0x03, 0x55, 0x1d, 0x13,
    ...
    0x06, 0x03, 0x55, 0x1d, 0x0e, 0x04, 0x16, 0x04, 0x14, 0x35, 0xe0, 0xd3, 0xe6, 0x04, 0xc5, 0x9d,
    0x52, 0x8e, 0x4d, 0xa6, 0x16, 0xdc, 0xbf, 0x56, 0xba, 0xd0, 0xc9, 0xaf, 0x5d, 0x30, 0x1f, 0x06,
    ...
    0x21, 0x00, 0xf1, 0xf0, 0xd7, 0xfc, 0xca, 0x30, 0x3c, 0xa3, 0x61, 0xb2, 0xb1, 0xd9, 0xab, 0xdb,
    0x7d, 0x02, 0x3e, 0x07, 0x4f, 0x43, 0x51, 0xca, 0x3d, 0xdd, 0x93, 0xdb, 0x3a, 0xca, 0x6d, 0xce,
    0x55, 0x22, 0x02, 0x21, 0x00, 0xcf, 0x4c, 0x94, 0xa0, 0x04, 0xef, 0x58, 0x8b, 0xa8, 0xcb, 0x4b,
    0x7b, 0xef, 0xbe, 0x5a, 0x85, 0x00, 0x2a, 0x29, 0x1b, 0x1f, 0xb5, 0x6b, 0xc5, 0x88, 0x08, 0x06,
    0x3a, 0x33, 0x9e, 0x18, 0x82,
];
...
impl Ca for SimCa {
    ...
    fn issue_svid(&self, req: &SvidRequest) -> Result<SvidMaterial, CaError> {
        ...
        // The leaf private key is the FIXTURE key whose public half is embedded
        // in `FIXTURE_SVID_CERT_*` — the matched pair minted offline (ADR-0063 D9
        // node-held custody; the sim returns a fixture leaf-key const, the same
